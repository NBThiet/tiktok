            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('action')}>
                    ...
                    <Menu items={currentUser ? userMenu : MENU_ITEMS} onChange={handleMenuchange}>
                        {currentUser ? (
                            <Image
                                src="htts://lh3.googleusercontent.com/ogw/AAEL6sjP8Ga-IvZb-R7-9nXQP-Vyxl0IilSU9RoUcRV6=s32-c-mo"
                                className={cx('user-avatar')}
                                alt="Skyyy"
                                fallBack="https://d11a6trkgmumsb.cloudfront.net/original/3X/d/8/d8b5d0a738295345ebd8934b859fa1fca1c8c6ad.jpeg"
                            />
                        ) : (
